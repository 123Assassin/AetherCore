...
const lessonSubNavItems = [
  ...
  { id: 'teaching', label: '题目变身', href: '/lesson/teaching' },
  { id: 'simulation', label: '互动实验', href: '/lesson/simulation' },
] as const;

const officeSubNavItems = [{ id: 'comment', label: '评语助手', href: '/office/comment' }] as const;
...
export function getShellRouteFromPath(pathname: string): {
  ...
  if (pathname === '/lesson/teaching' || pathname.startsWith('/lesson/teaching/')) {
    return { activeCategory: 'teaching', activeTab: 'lesson', pathname };
  }
